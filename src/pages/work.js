   ...
   return (
     <div className="site__wrapper">
      <div className="index__wrapper">
        ...
        Here is a list of some of the companies and organizations that I have been involved with through the years.
        </p>
        <div className="scrollable-box">
          <div className="listItem">
            <h4 className="secondary__info">Capital One, <span> Software Engineer </span></h4>
            <h5> May 2016 - present </h5>
          </div>
          <ul>
            <li> Create A/B Tests </li>
            <li> Work on high-traffic pages like www.capitalone.com </li>
            <li> Convert Header/Footer from monolithic Jquery code base to Preact </li>
          </ul>
          <div className="listItem">
            <h4 className="secondary__info">Hack Reactor, <span> Software Engineering Fellow </span></h4>
          ...
          <div className="listItem">
            <h4 className="secondary__info">The Hamlin School, <span> Associate 2nd Grade Teacher</span></h4>
